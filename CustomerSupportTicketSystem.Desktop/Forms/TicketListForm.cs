...
public partial class TicketListForm : Form
{
    ...
    private void btnViewDetails_Click(object sender, EventArgs e)
    {
        ...
        var detailsForm = new TicketDetailsForm(selectedTicket.TicketId);
        this.Hide();
        detailsForm.FormClosed += async (s, args) => 
        {
            this.Show();
            await LoadTickets(); // Refresh list in case status changed
        };
        detailsForm.Show();
    }
    ...
    private void btnCreateTicket_Click(object sender, EventArgs e)
    {
        ...
        this.Hide();
        createForm.FormClosed += async (s, args) =>
        {
            this.Show();
